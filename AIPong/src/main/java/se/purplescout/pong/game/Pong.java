        ...
        for (int i = 0; i < steps; i++) {
            ...
            if (ball.getBoundingBox().getX() < 0) {
                ...
                if (someoneScoredListener != null) {
                    someoneScoredListener.someoneScored(RIGHT, rightPaddle.getTeamName(), rightPaddle);
                }
                ...
                if (someoneScoredListener != null) {
                    someoneScoredListener.someoneScored(LEFT, leftPaddle.getTeamName(), leftPaddle);
                }
